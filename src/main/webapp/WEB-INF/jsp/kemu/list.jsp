...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-10" style="background: #fffcfa" >
            ...
            <a class="large blue button f-ml20 f-mt20" data-toggle="modal" data-target="#addModal" href="addKemu">新增科目</a>
            <!-- Modal -->
            ...
            <table id="tb_roles" class="table table-bordered  table-hover  f-ml10">
                ...
                <c:forEach items="${tmKemus}" var="kemu">
                    <tr>
                        <td style="width: 70%">${kemu.name}</td>


                        <td>
                            <a class="large green button f-mr20 myModel" data-toggle="modal" data-target="#editModal" href="editKemu?kemuid=${kemu.id}">修改科目</a>
                            <a class="large orange button f-mr20" data-toggle="modal" onclick="delKemu(${kemu.id})">删除科目</a>
...
<script>
    ...
    function  delKemu(kemuid) {
        var r= confirm("你确定要删除该科目吗?");
        if(r){
            $.ajax({
                url:"deleteKemu?kemuid="+kemuid,
