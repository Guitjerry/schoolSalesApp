...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-10" style="background: #fffcfa" >
            ...
            <a class="large blue button f-ml20 f-mt20" data-toggle="modal" data-target="#addModal" href="addJilvChild">新增纪律</a>
            <!-- Modal -->
            ...
            <table id="tb_roles" class="table table-bordered  table-hover  f-ml10">
                ...
                <th data-valign="middle" data-align="center" >纪律范围</th>
                ...
                <c:forEach items="${tmClassJiLvChildList}" var="jilv">
                    <tr>
                        <td style="width: 20%">${jilv.name}</td>
                        <td style="width: 20%"><c:if test="${jilv.type==1}">个人纪律</c:if><c:if test="${jilv.type==2}">班级纪律</c:if></td>
                        <td style="width: 20%">${jilv.parentname}</td>


                        <td>
                            <a class="large green button f-mr20 myModel" data-toggle="modal" data-target="#editModal" href="editJilvChild?jilvId=${jilv.id}">修改纪律</a>
...
<script>
    ...
    function  delJilv(jilvid) {
        var r= confirm("你确定要删除该明细纪律吗?");
        if(r){
            $.ajax({
                url:"deleteJilvChild?jilvId="+jilvid,
